    ...
    if (error) {
        ...
        if (email) {
            ...
            const user = new User({
                ...
                role: req.body.role,
                isAdmin: req.body.role === "Administrator" ? true : false,
                created: moment(Date.now()).format('LL'),
                privileges: {
                    read: req.body.role === "Administrator" ? true : false,
                    create: req.body.role === "Administrator" ? true : false,
                    update: req.body.role === "Administrator" ? true : false,
                    delete: req.body.role === "Administrator" ? true : false,
                },
                request: req.body.role === "Administrator" ? true : false,
